                            ...
                            <ul class="list-inine ps-0 mb-4">
                                    ...
                                    <a href="javascript: void(0);">
                                        <div class="border rounded avatar-md">
                                            <span class="avatar-title bg-transparent">
                                                <img src="<?php echo e(URL::asset('assets/images/companies/img-1.png')); ?>" alt="" class="avatar-md p-2">
                                            </span>
                                        </div>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="javascript: void(0);">
                                        <div class="border rounded avatar-md">
                                            <span class="avatar-title bg-transparent">
                                                <img src="<?php echo e(URL::asset('assets/images/companies/img-2.png')); ?>" alt="" class="avatar-md p-2">
                                            </span>
                                        </div>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="javascript: void(0);">
                                        <div class="border rounded avatar-md">
                                            <span class="avatar-title bg-transparent">
                                                <img src="<?php echo e(URL::asset('assets/images/companies/img-3.png')); ?>" alt="" class="avatar-md p-2">
                                            </span>
                                        </div>
                                    </a>
                                </li>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\morpich\laravl\Dason_Laravel_v1.1.0\Admin\resources\views/tasks-kanban.blade.php ENDPATH**/ ?>